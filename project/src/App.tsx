...
const FALLBACK_UNIT_DATA = {
  ...
  'b1': { name: 'b1', size: '1,500 sq ft', availability: 'Available', amenities: 'Premium package', floorPlanUrl: 'https://drive.google.com/uc?export=view&id=1qzM6Y6tOdFa3pEwaX5rxyUvPrIzCwoYv' },
  'b2': { name: 'b2', size: '1,500 sq ft', availability: 'Available', amenities: 'Premium package', floorPlanUrl: 'https://drive.google.com/uc?export=view&id=1qzM6Y6tOdFa3pEwaX5rxyUvPrIzCwoYv' },
  ...
  'c13': { name: 'c13', size: '900 sq ft', availability: 'Available', amenities: 'Basic package', floorPlanUrl: 'https://drive.google.com/uc?export=view&id=1qzM6Y6tOdFa3pEwaX5rxyUvPrIzCwoYv' },
